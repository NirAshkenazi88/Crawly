...
#Usage
1. Scan IP range (/24) or single hostname for specific ports and take screenshot
> python crawly.py -ip 192.168.1.0 -port 80,443 -path /robots.txt
2. Scan single IP or hostname from text file for specific ports and take screenshot
